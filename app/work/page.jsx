...
const Work = () => {
  ...
  const handleSlideChange = (swiper) => {
    //get current slide index from slide
    const currentIndex = swiper.activeIndex;

    //updating the current slide state based on slide index
    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-[30px]">
          <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 cl:order-none">
